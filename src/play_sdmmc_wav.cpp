...
// bool AudioPlaySdMmcWav::play(const char *filename)
// {
// 	stop();
...
// void AudioPlaySdMmcWav::stop(void)
// {
// 	if (state != STATE_STOP) {
...
// bool AudioPlaySdMmcWav::consume(uint32_t size)
// {
// 	uint32_t len;
// 	uint8_t lsb, msb;
// 	const uint8_t *p;
...
// bool AudioPlaySdMmcWav::parse_format(void)
// {
// 	uint8_t num = 0;
// 	uint16_t format;
// 	uint16_t channels;
...
// bool AudioPlaySdMmcWav::isPlaying(void)
// {
// 	uint8_t s = *(volatile uint8_t *)&state;
// 	return (s < 8);
// }

// uint32_t AudioPlaySdMmcWav::positionMillis(void)
// {
// 	uint8_t s = *(volatile uint8_t *)&state;
// 	if (s >= 8) return 0;
...
// uint32_t AudioPlaySdMmcWav::lengthMillis(void)
// {
// 	uint8_t s = *(volatile uint8_t *)&state;
// 	if (s >= 8) return 0;
// 	uint32_t tlength = *(volatile uint32_t *)&total_length;
